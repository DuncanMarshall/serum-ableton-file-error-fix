...
3.  All of Serum's open samples should no longer be open in the background now, and you can import it in to serum by dragging.  Other files should still play and be visible in the playlist.
